    ...
    for i in range(1, num_page):
        try : 
            ...
            for idx, rev in enumerate(cont):
                ...
                try : 
                    rating = review_inner.find('span', {"class": re.compile("ui_bubble_rating\sbubble_..")})['class'][1][-2:]
                ...
                'rating': rating, 'review': review_text, 'rating_review': rating_review, 'n_review_user': n_reviews, 'n_votes_review': votes}
